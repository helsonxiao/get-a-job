...
- **Web 图鉴** — FastAPI 应用，职位 / 公司 / 行业三维视图：职位列表与详情、公司图鉴（三榜/象限/对比 + 全局公司抽屉）、市场观察台（薪资/热力/信号/技能 + 图表下钻）、行业观察（卡片墙 + 行业详情 + 政策分析挂载位）、规则配置与画像编辑、主简历；统计胶囊直达筛选，支持热重载
