...
async def api_jobs(
    ...
    welfare: str = Query("", description="福利标签筛选 (welfare LIKE)"),
    salary_months: Optional[int] = Query(None, description="薪资月数筛选 (如 13)"),
    scale_bucket: str = Query("", description="公司规模段 (雇主画像下钻: 50人以下/50-150人/150-500人/500-1000人/1000人以上/未知规模)"),
    hours_bucket: str = Query("", description="工时段 (雇主画像下钻: ≤8h/8-9h/9-10h/10h+/未知)"),
